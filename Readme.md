...
#### 1.**Hardware platform**
  ...
  - An I2C master is implemented into the FPGA (on KC705 EVB) to configure GBCR2 chip. The I2C interface (on connector **J46**) mapping on KC705 EVB is shown in below figure:
